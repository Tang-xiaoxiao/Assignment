...
# Method: Explanation
# 训练
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_train.py --dataset rad --method Explanation --epoch 200 --lr 5e-4 --bs 8 --source_len 512 --target_len 256 --train_text_file_path Training_Set/Training_Set/Training_feature/train_vqa_formatted_short.json --img_file_path Training_Set/Training_Set/Training_feature/detr.pth --img_name_map Training_Set/Training_Set/Training_feature/name_map.json --pretrained_model_path Medthink-main/unifiedqa-t5-base --output_dir ours_short_closed_end_experiments
# 推理
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_generate.py --dataset rad --method Explanation  --source_len 512 --target_len 256 --text_file_path Test_Set/Test_Set/test_vqa_formatted.json --model_path ours_short_closed_end_experiments/Explanation --img_file_path Test_Set/Test_Set/Test_feature/detr.pth --img_name_map Test_Set/Test_Set/Test_feature/name_map.json --output_dir ours_short_closed_end_experiments

# Method: Reasoning
# 训练
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_train.py --dataset rad --method Reasoning --epoch 200 --lr 5e-4 --bs 8 --source_len 512 --target_len 256 --train_text_file_path Training_Set/Training_Set/Training_feature/train_vqa_formatted_short.json --img_file_path Training_Set/Training_Set/Training_feature/detr.pth --img_name_map Training_Set/Training_Set/Training_feature/name_map.json --pretrained_model_path Medthink-main/unifiedqa-t5-base --output_dir ours_short_closed_end_experiments
# 推理
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_generate.py --dataset rad --method Reasoning  --source_len 512 --target_len 256 --text_file_path Test_Set/Test_Set/test_vqa_formatted.json --model_path ours_short_closed_end_experiments/Reasoning --img_file_path Test_Set/Test_Set/Test_feature/detr.pth --img_name_map Test_Set/Test_Set/Test_feature/name_map.json --output_dir ours_short_closed_end_experiments

# Method: Two-Stage Reasoning
# 第一阶段训练
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_train.py --dataset rad --method First-Stage_Reasoning --epoch 200 --lr 5e-4 --bs 8 --source_len 512 --target_len 256 --train_text_file_path Training_Set/Training_Set/Training_feature/train_vqa_formatted_short.json --img_file_path Training_Set/Training_Set/Training_feature/detr.pth --img_name_map Training_Set/Training_Set/Training_feature/name_map.json --pretrained_model_path Medthink-main/unifiedqa-t5-base --output_dir ours_short_closed_end_experiments
# 第一阶段推理
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_generate.py --dataset rad --method First-Stage_Reasoning --source_len 512 --target_len 256 --text_file_path Training_Set/Training_Set/Training_feature/train_vqa_formatted_short.json --model_path ours_short_closed_end_experiments/First-Stage_Reasoning --img_file_path Training_Set/Training_Set/Training_feature/detr.pth --img_name_map Training_Set/Training_Set/Training_feature/name_map.json --output_dir ours_short_closed_end_experiments
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_generate.py --dataset rad --method First-Stage_Reasoning --source_len 512 --target_len 256 --text_file_path Test_Set/Test_Set/test_vqa_formatted.json --model_path ours_short_closed_end_experiments/First-Stage_Reasoning --img_file_path Test_Set/Test_Set/Test_feature/detr.pth --img_name_map Test_Set/Test_Set/Test_feature/name_map.json --output_dir ours_short_closed_end_experiments
# 第二阶段训练
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_train.py --dataset rad --method Second-Stage_Reasoning --epoch 10 --lr 5e-5 --bs 8 --source_len 512 --target_len 32 --train_text_file_path ours_closed_end_experiments/First-Stage_Reasoning/train.json --img_file_path Training_Set/Training_Set/Training_feature/detr.pth --img_name_map Training_Set/Training_Set/Training_feature/name_map.json --pretrained_model_path Medthink-main/unifiedqa-t5-base --output_dir ours_short_closed_end_experiments
# 第二阶段推理
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_generate.py --dataset rad --method Second-Stage_Reasoning --source_len 512 --target_len 32 --text_file_path ours_closed_end_experiments/First-Stage_Reasoning/test.json --model_path ours_short_closed_end_experiments/Second-Stage_Reasoning --img_file_path Test_Set/Test_Set/Test_feature/detr.pth --img_name_map Test_Set/Test_Set/Test_feature/name_map.json --output_dir ours_short_closed_end_experiments

# Method: without_R
# 训练
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_train.py --dataset rad --method without_R --epoch 200 --lr 5e-4 --bs 8 --source_len 512 --target_len 32 --train_text_file_path Training_Set/Training_Set/Training_feature/train_vqa_formatted_short.json --img_file_path Training_Set/Training_Set/Training_feature/detr.pth --img_name_map Training_Set/Training_Set/Training_feature/name_map.json --pretrained_model_path Medthink-main/unifiedqa-t5-base --output_dir ours_short_closed_end_experiments
# 推理
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python closed_end_generate.py --dataset rad --method without_R --source_len 512 --target_len 32 --text_file_path Test_Set/Test_Set/test_vqa_formatted.json --model_path ours_short_closed_end_experiments/without_R --img_file_path Test_Set/Test_Set/Test_feature/detr.pth --img_name_map Test_Set/Test_Set/Test_feature/name_map.json --output_dir ours_short_closed_end_experiments
